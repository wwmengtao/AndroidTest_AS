...
import com.mt.myapplication.oschina.gson.DoubleJsonDeserializer;
import com.mt.myapplication.oschina.gson.FloatJsonDeserializer;
...
public final class AppOperator {
    private volatile static ExecutorService EXECUTORS_INSTANCE;
