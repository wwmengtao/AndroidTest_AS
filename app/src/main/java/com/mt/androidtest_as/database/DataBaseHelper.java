...
public class DataBaseHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_NAME = "androidtest_at.db";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		//execSQL用于执行SQL语句
		db.execSQL("create table "+ ATDbSchema.ATDataTable.NAME+"("
				+" _id integer primary key autoincrement, "
				+ATDataTable.Cols.UUID+","
				+ATDataTable.Cols.TITLE+")"
		);
	}
	...
	public void onUpgrade(SQLiteDatabase db, int arg1, int arg2) {
        ...
        try {
            db.execSQL("drop table if exists "+ATDataTable.NAME);
            onCreate(db);
