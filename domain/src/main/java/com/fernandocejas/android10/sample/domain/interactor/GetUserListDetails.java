 ...
 */
public class GetUserListDetails extends UseCase<List<User>, GetUserListDetails.Params> {
  ...
  @Override Observable<List<User>> buildUseCaseObservable(GetUserListDetails.Params params) {
