...
public class Images_UIL {

	public final static String[] imageThumbUrls_GL = new String[] {
		"assets://largepics/cat.jpg", // Image from assets
		...
		"drawable://" + R.drawable.ic_launcher, // Image from drawables
		"http://upload.wikimedia.org/wikipedia/ru/b/b6/���ѧ�_�ܧ��_��_�ާ��ѧާ�_�ӧ�֧ӧѧ�.png", // Link with UTF-8
