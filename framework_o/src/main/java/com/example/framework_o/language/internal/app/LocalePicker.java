        ...
        for (String locale : localeList) {
            ...
            if (localeInfos.isEmpty()) {
                ...
                if (previous.locale.getLanguage().equals(l.getLanguage()) &&
                    ...
                    // MOTO BEGIN pwn687 IKL10NTOOLS-2743 Support Zawgyi Font
                    if (l.toString().equalsIgnoreCase("my_MM") || l.toString().equalsIgnoreCase("en_ZG")) {
                        displayName = toTitleCase(getDisplayName(l, specialLocaleCodes, specialLocaleNames));
                    }
                    if (DEBUG) {
