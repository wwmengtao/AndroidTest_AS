...
public class LocaleHelper {
    ...
    public static String getDisplayName(Locale locale, Locale displayLocale, boolean sentenceCase) {
        ...
        // BEGIN Moto pwn687 IKSWM-53301 Zawgyi font support
        if (locale.toString().equalsIgnoreCase("en_ZG")) {
            Locale l = new Locale("my", "");
            return ULocale.getDisplayName(l.toLanguageTag(), ULocale.forLocale(l)) + " (Zawgyi)";
        } else if (locale.toString().equalsIgnoreCase("my_MM")) {
            Locale l = new Locale("my", "");
            return ULocale.getDisplayName(l.toLanguageTag(), ULocale.forLocale(l)) + " (Myanmar)";
        }
        // END Moto
    ...
    public static String getDisplayCountry(Locale locale) {
        ...
        if (locale.toString().equalsIgnoreCase("en_ZG")) {
            return "Zawgyi";
        } else if (locale.toString().equalsIgnoreCase("en_ZG")) {
            return "Myanmar";
        } else {
