...
public interface ParseXml {
  Observable<List<UserEntityNT>> userEntityNTList(final GetUserNTList.Params params, DbCache dbCache);
  Observable<UserEntityNT> userEntityNT(final GetUserNTList.Params params, DbCache dbCache);
}
